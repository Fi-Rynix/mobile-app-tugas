...
class DashboardPage extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    final dashboardState = ref.watch(dashboardModifierProvider);
    ...
    return Scaffold(
      body: dashboardState.when(
        ...
        error: (error, stack) => CustomErrorWidget(
          ...
          onRetry: () {
            ref.read(dashboardModifierProvider.notifier).refresh();
          },
        ),
        data: (dashboardData) {
          return RefreshIndicator(
            onRefresh: () async {
              ref.invalidate(dashboardModifierProvider);
            },
  ...
  // custom slide transit waktu pindah page
